<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="SearchTheatre.aspx.cs" Inherits="SearchMovie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="col-md-12" style="border-right: 1px dotted #C2C2C2;padding-right: 30px;">
                        ...
                        <ul class="nav nav-tabs">
                               <li class="active"><a href="#Registration" data-toggle="tab">Search Theatre</a></li>
                        </ul>
                        <!-- Tab panes -->
                            ...
                            <div role="form" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Theatre Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="MovieName" placeholder="Theatre Name" runat="server" />
                                    </div>
                                </div>
                                 <div class="row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <asp:Button ID="Btn_Submit" runat="server" Text="Search Theatre" CssClass="btn btn-primary btn-sm" OnClick="Btn_Submit_Click"/>
